...
pump = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div/div[2]/div/div[4]/ul/li/a'))).click()
mono = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[1]/div[2]/div/div[1]/ul/li/a'))).click()
jp = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[1]/div[2]/div/div[2]/ul/li/a'))).click()
...
# ir3 = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[2]/div[1]/div[2]/div/div[1]/ul/li[2]/form/label'))).click()
# time.sleep(1)
# sel_apply = driver.find_element(By.LINK_TEXT, "Aplicar seleção").click()
# time.sleep(2)

voltage = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[2]/div/div[7]/div[1]/h4/a'))).click()
voltage3 = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[2]/div/div[7]/div[2]/div/div[1]/ul/li[2]/form/label'))).click()
time.sleep(1)
sel_apply = driver.find_element(By.LINK_TEXT, "Aplicar seleção").click()
time.sleep(2)

# sealing = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[2]/div[14]/div[1]/h4/a'))).click()
# mech_seal = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[2]/div[14]/div[2]/div/div[1]/ul/li[2]/form/label'))).click()
# time.sleep(1)
# sel_apply = driver.find_element(By.LINK_TEXT, "Aplicar seleção").click()
# time.sleep(2)
...
# pages_total = pg_total[pg_total.find('1'):pg_total.find('Próximo')]
...
motors.to_excel(r'C:\Users\gustavo.andrade\Downloads\motors_jp.xlsx', index = False)
