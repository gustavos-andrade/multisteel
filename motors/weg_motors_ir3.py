...
energy_efficiency = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div/div[2]/div/div[2]/ul/li/a'))).click()
w22 = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[1]/div[1]/div/div[1]/div[2]/div/div[3]/ul/li/a'))).click()
...
ir3 = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[2]/div/div[1]/div[2]/div/div[1]/ul/li[1]/form/label'))).click()
time.sleep(1)
...
wt_flange = wait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div[4]/div[1]/div/div[2]/div[8]/div[2]/div/div[2]/div/div[12]/div[2]/div/div[1]/ul/li[4]/form/label'))).click()
time.sleep(1)
sel_apply = driver.find_element(By.LINK_TEXT, "Aplicar seleção").click()
time.sleep(2)
...
motors.to_excel(r'C:\Users\gustavo.andrade\Downloads\motors_ir3_premium.xlsx', index = False)
